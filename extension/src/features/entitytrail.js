...
import { extractPosition, calculateDistance, buildEntityState } from './movement.js';
...
export { startEntityTrailTracking, stopEntityTrailTracking, toggleEntityTrail, drawEntityTrail };
