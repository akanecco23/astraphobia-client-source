...
const getAllPropertyNames = (v39e0TargetObject) => {
  return [
    ...Object.getOwnPropertyNames(Object.getPrototypeOf(v39e0TargetObject)),
    ...Object.getOwnPropertyNames(v39e0TargetObject),
  ];
};
